...
mkdir -p out/target/product/draconis/rep-boot
rm -rf   out/target/product/draconis/rep-boot
mkdir -p out/target/product/draconis/rep-boot


# step 1. unpack boot.img
pushd out/target/product/draconis/rep-boot
...
cp -v $PRGDIR/{file_contexts,property_contexts,sepolicy} out/target/product/draconis/rep-boot/cpio

...
public class ZMAXDozeService extends Service {
    private static final String TAG = "ZMAXDozeService";
    ...
    private ZMAXProximitySensor mSensor;
    ...
    class ZMAXProximitySensor implements SensorEventListener {
        ...
        public ZMAXProximitySensor(Context context) {
		...
		if (DEBUG) Log.d(TAG, String.format("ZMAXDozeService: mInPocketTime = %d", mInPocketTime));
            }
            mSawNear = isNear;
        }
	    ...
	    if (DEBUG) Log.d(TAG, String.format("ZMAXDozeService: delta = %d", delta));
        ...
        public void enable() {
            if (mHandwaveGestureEnabled || mPocketGestureEnabled) {
		if (DEBUG) Log.d(TAG, "ZMAXDozeService: registerListener");
                mSensorManager.registerListener(this, mSensor, SensorManager.SENSOR_DELAY_NORMAL);
            }
        }

        public void disable() {
	    if (DEBUG) Log.d(TAG, "ZMAXDozeService: disable");
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "ZMAXDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new ZMAXProximitySensor(mContext);
	...
	if (DEBUG) Log.d(TAG, String.format("ZMAXDozeService: loadPreferences - mHandwaveGestureEnabled = %b, mPocketGestureEnabled = %b",
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener mPrefListener =
	    ...
	    if (DEBUG) Log.d(TAG, String.format("ZMAXDozeService: onSharedPreferenceChanged - mHandwaveGestureEnabled = %b, mPocketGestureEnabled = %b",
		mHandwaveGestureEnabled, mPocketGestureEnabled));
        }
    };
}
